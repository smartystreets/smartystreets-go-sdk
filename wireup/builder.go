...
// BuildInternationalStreetAPIClient builds the us-extract-api client using the provided
// configuration details provided by other methods on the ClientBuilder.
func (b *ClientBuilder) BuildInternationalStreetAPIClient() *international.Client {
	b.ensureBaseURLNotNil(defaultBaseURL_InternationalStreetAPI)
	return international.NewClient(b.buildHTTPSender())
}
